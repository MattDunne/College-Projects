...
public class ProgramList_MainActivity extends Activity {
        ...
        programListView.setOnItemClickListener(new OnItemClickListener() {
        		...
        		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if(!isNetworkAvailable())
                    		new AlertDialog.Builder(ProgramList_MainActivity.this).
        			...
        			/*
        			if(selectedValue.equals("Computing Systems")) {        				
        				Intent computingScreen = new Intent(getApplicationContext(), ComputingActivity.class);
        				startActivity(computingScreen);
