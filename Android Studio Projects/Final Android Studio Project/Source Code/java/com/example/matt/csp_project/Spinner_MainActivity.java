...
public class Spinner_MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Spinner_MainActivity.this,
        ...
        ArrayAdapter<String> y_arrayAdapter = new ArrayAdapter<String>(Spinner_MainActivity.this,
        ...
        b.setOnClickListener(new View.OnClickListener() {
        	...
        	public void onClick(View arg0) {                            	
        		if(p.equals("Select Program") || y.equals("Select Year"))
                   	new AlertDialog.Builder(Spinner_MainActivity.this).
					...
					Toast.makeText(Spinner_MainActivity.this,"You Selected : "
