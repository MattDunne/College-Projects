...
public class Contacts_MainActivity extends AppCompatActivity {
    ...
    private void call(String pn) {
        ...
        try {
        		...
        		Toast.makeText(Contacts_MainActivity.this, "There are no phone clients installed.", Toast.LENGTH_SHORT).show();
        }
    }
    
    private void sendEmail() {
    		if(!isNetworkAvailable())
    			new AlertDialog.Builder(Contacts_MainActivity.this).
			...
			Intent emailIntent = new Intent(Intent.ACTION_SEND);
    			...
    			try {
    				...
    				Toast.makeText(Contacts_MainActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
    			}    	
		}                               
    }
